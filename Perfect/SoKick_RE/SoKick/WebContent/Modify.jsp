...
<% 
String studentnum = (String)session.getAttribute("sid");
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" action="Update.jsp" method="post">
					<span class="login100-form-title">
						SO-KICK 회원정보수정
					</span>

					<div class="wrap-input100 validate-input m-b-16" data-validate="학번을 입력해주세요">
						<input class="input100" type="text" value=<%=studentnum%> name="input_id" placeholder="학번">
						<span class="focus-input100"></span>
                    </div>
                    
					<div class="wrap-input100 validate-input" data-validate =  "비밀번호를 입력해주세요">
						<input class="input100" type="password" value=<%=password%> name="input_pw" placeholder="비밀번호">
						<span class="focus-input100"></span>
                    </div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate =  "이름을 입력해주세요">
                            <input class="input100" type="text" value=<%=name%> name="input_name" placeholder="이름">
                            <span class="focus-input100"></span>
                    </div>
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "전화번호를 입력해주세요">
                            <input class="input100" type="tel" value=<%=phonenum%> name="input_phone" placeholder="전화번호">
                            <span class="focus-input100"></span>
                    </div>
					...
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" onclick="click_sign_in();">
							회원 정보 수정
						</button>
                    </div>
...
<script>
	...
	function emptycheck(){
		...
		|| (document.getElementById("major").value=="") || (document.getElementById("phonenum").value == ""){
			alert("필수항목(*)을 빠짐없이 입력해주세요");
			return;			
		}
	}
